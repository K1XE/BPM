...
# Paper runs did not reset the delta-rule state at packed-sequence boundaries.
_GDN_NO_BOUNDARY_RESET = _os.environ.get("BPM_GDN_NO_BOUNDARY_RESET", "0") == "1"
...
class Qwen3_5GatedDeltaNet(nn.Module):
    ...
    def forward(
        ...
        core_attn_out, last_recurrent_state = self.chunk_gated_delta_rule(
            ...
            **({} if _GDN_NO_BOUNDARY_RESET else {"cu_seqlens": cu_seqlens}),
        )
