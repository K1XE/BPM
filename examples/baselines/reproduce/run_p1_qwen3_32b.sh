#!/usr/bin/env bash
# Paper pair P1: Qwen3-32B -> Qwen3.5-2B, cross-tokenizer baselines
...
export TEACHER_MODEL_PATH="${TEACHER_MODEL_PATH:-${BPM_TEACHER_MODEL_PATH:?path to Qwen3-32B HF checkpoint}}"
