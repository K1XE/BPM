#!/usr/bin/env bash
# Paper pair P2: GLM-Z1-9B -> Qwen3.5-2B, cross-tokenizer baselines
...
export TEACHER_MODEL_PATH="${TEACHER_MODEL_PATH:-${BPM_TEACHER_MODEL_PATH:?path to GLM-Z1-9B HF checkpoint}}"
