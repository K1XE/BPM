        ...
        *,
        ...
        for data in read_file(path):
            ...
            if apply_chat_template:
                # Store the raw messages before templating so cross-tokenizer
                # distillation can re-format the prompt with the teacher
                # tokenizer's own chat template (see slime_plugins/bpm).
                if isinstance(prompt, list):
                    metadata["raw_messages"] = prompt
