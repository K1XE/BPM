...
# Paper pair P3: MiniMax-M2.7 (teacher) -> Qwen3.5-2B (student)
# See README.md
...
export BPM_TEACHER_MODEL_PATH="${BPM_TEACHER_MODEL_PATH:?path to MiniMax-M2.7 HF checkpoint}"
export TEACHER_TP_SIZE="${TEACHER_TP_SIZE:-8}"
export TEACHER_DP_SIZE="${TEACHER_DP_SIZE:-1}"
# EP == TP: per-expert size is not FP8-block-divisible
