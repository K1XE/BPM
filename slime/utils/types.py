...
class Sample:
    ...
    teacher_token_ids: list[int] | None = None  # Teacher-tokenizer response token ids for BPM distillation
    teacher_hidden_states: torch.Tensor | None = None  # Teacher last-layer hidden states for BPM distillation
    teacher_response_text: str | None = None  # Teacher-rendered response text for BPM byte alignment
